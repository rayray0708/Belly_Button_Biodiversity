...
First I created a horizontal bar chart with a dropdown menu to display the top 10 microbial species found in a chosen individual that looks like the following:
![Alt text](<Screenshot 2023-12-18 at 4.00.42 pm.png>)

Additionally, a `Demographic Info` box was created to display the sample metadata. I also created a bubble chart to display the frequency of each microbial species with the following features:
...
![Alt text](<Screenshot 2023-12-18 at 4.06.23 pm.png>)
